...
namespace FirstDatabase {
    ...
    public partial class Database11DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmployeeID, string LastName, string First_Name) {
...
namespace FirstDatabase.Database11DataSetTableAdapters {
    ...
    public partial class AssetsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FirstDatabase.Properties.Settings.Default.Database11ConnectionString;
        }
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `LastName` IS N" +
                "ULL) OR (`LastName` = ?)) AND ((? = 1 AND `First Name` IS NULL) OR (`First Name`" +
                " = ?)))";
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`EmployeeID`, `LastName`, `First Name`) VALUES (?, ?, ?)" +
                "";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("EmployeeID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "EmployeeID", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Employees` SET `EmployeeID` = ?, `LastName` = ?, `First Name` = ? WHERE (" +
                "(`EmployeeID` = ?) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND " +
                "((? = 1 AND `First Name` IS NULL) OR (`First Name` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, [First Name] FROM Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_LastName, string Original_First_Name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int EmployeeID, string LastName, string First_Name) {
        ...
        public virtual int Update(int EmployeeID, string LastName, string First_Name, int Original_EmployeeID, string Original_LastName, string Original_First_Name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string First_Name, int Original_EmployeeID, string Original_LastName, string Original_First_Name) {
            return this.Update(Original_EmployeeID, LastName, First_Name, Original_EmployeeID, Original_LastName, Original_First_Name);
        }
    }
